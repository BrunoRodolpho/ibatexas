        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              {instagramUrl && (
                <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="min-w-[44px] min-h-[44px] flex items-center justify-center text-smoke-500 hover:text-smoke-50 transition-colors" aria-label="Instagram">
              ...
              {facebookUrl && (
                <a href={facebookUrl} target="_blank" rel="noopener noreferrer" className="min-w-[44px] min-h-[44px] flex items-center justify-center text-smoke-500 hover:text-smoke-50 transition-colors" aria-label="Facebook">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                </a>
              )}
              {whatsappUrl && (
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="min-w-[44px] min-h-[44px] flex items-center justify-center text-smoke-500 hover:text-smoke-50 transition-colors" aria-label="WhatsApp">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2 text-sm">
              <Link href="/search" className="text-smoke-400 hover:text-smoke-50 transition-colors">
                {t('nav.shop')}
              </Link>
              <Link href="/loja" className="text-smoke-400 hover:text-smoke-50 transition-colors">
                {t('nav.loja')}
              </Link>
              <Link href="/account/reservations" className="text-smoke-400 hover:text-smoke-50 transition-colors">
                {t('nav.reservations')}
              </Link>
              <Link href="/account" className="text-smoke-400 hover:text-smoke-50 transition-colors">
                {t('nav.account')}
              </Link>
            </nav>
          </div>
        ...
        <div className="mx-auto max-w-[1280px] px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 py-4">
            ...
            <div className="flex gap-4">
              <Link href="/privacidade" className="text-xs text-smoke-500 hover:text-smoke-50 transition-colors">
                Política de Privacidade
              </Link>
              <Link href="/termos" className="text-xs text-smoke-500 hover:text-smoke-50 transition-colors">
                Termos de Uso
              </Link>
            </div>
          </div>
