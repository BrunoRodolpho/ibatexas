        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-slate-100">
          ...
          <div className="py-5 pr-5">
            ...
            <div className="mt-2 space-y-1">
              {phone && <p className="text-[12px] text-slate-600">{phone}</p>}
              {address && <p className="text-[12px] text-slate-500">{address}</p>}
            </div>
          </div>
          ...
          <div className="py-5 px-5">
            ...
            <div className="mt-2 space-y-0.5">
              <p className="text-[12px] text-slate-600">{t("footer.monday_to_friday")}: {hoursWeekday}</p>
              <p className="text-[12px] text-slate-500">{t("footer.saturday")}: {hoursSaturday}</p>
              <p className="text-[12px] text-slate-500">{t("footer.sunday")}: {hoursSunday}</p>
            </div>
          </div>
          ...
          <div className="py-5 px-5">
            ...
            <div className="mt-2 flex flex-col gap-1">
              <Link href="/search" className="text-[12px] text-slate-600 hover:text-slate-900 transition-colors">
                {t("nav.shop")}
              </Link>
              <Link href="/account/reservations" className="text-[12px] text-slate-600 hover:text-slate-900 transition-colors">
                {t("nav.reservations")}
              </Link>
              <a href="#" className="text-[12px] text-slate-500 hover:text-slate-900 transition-colors">
                {t("footer.privacy")}
              </a>
            </div>
          </div>
          ...
          <div className="py-5 pl-5">
            ...
            <div className="mt-2 flex gap-2.5">
              {instagramUrl && (
                <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-600 transition-colors" aria-label="Instagram">
              ...
              {facebookUrl && (
                <a href={facebookUrl} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-600 transition-colors" aria-label="Facebook">
              ...
              {whatsappUrl && (
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-600 transition-colors" aria-label="WhatsApp">
