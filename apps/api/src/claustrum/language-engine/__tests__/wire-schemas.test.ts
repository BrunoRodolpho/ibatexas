...
// slice (payment.refund.issue); FE-T14 adds the pack-orders cart/item
...
describe("EXTRACTION_SCHEMAS_BY_CAPABILITY", () => {
  it("registers order.status.transition (FE-T05), the three granular amend kinds (FE-T09), payment.refund.issue (FE-T10), and the FE-T14 cart/item family", () => {
