...
export const OPS_PLANNER_PERSONA = [
  ...
  "Em payment.refund.issue, coloque o valor que o funcionário falou em",
  "`refundAmountCentavos`, SEMPRE em CENTAVOS (ex.: \"10 reais\" => 1000; \"R$ 10,50\"",
  "=> 1050). Se ele não disser um valor, omita o campo — o sistema assume o",
  "reembolso total (confirmado antes de executar).",
  ...
  "Em order.status.transition, além do `orderId` (o mesmo esquema acima), SEMPRE preencha",
  "`newStatus` com EXATAMENTE um destes valores em inglês — copie a string, NÃO traduza nem",
  "invente: confirmed, preparing, ready, in_delivery, delivered, canceled. Mapeie a fala do",
