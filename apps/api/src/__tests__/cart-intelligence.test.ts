...
vi.mock("@ibatexas/domain", () => ({
  ...
  createOrderCommandService: () => ({
    ...
    // Task 16: envelope-typed entry points return EXECUTE outcomes by default
...
describe("startCartIntelligenceSubscribers", () => {
  ...
  it("subscribes to all intelligence event handlers", async () => {
    ...
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("cart.abandoned", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("order.placed", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("product.viewed", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("order.payment_failed", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("review.prompt.schedule", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("notification.send", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("reservation.created", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("reservation.modified", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("reservation.cancelled", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("reservation.no_show", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("review.prompt", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("search.results_viewed", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("order.refunded", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("order.disputed", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("order.canceled", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("review.submitted", expect.any(Function), { queueGroup: "cart-intelligence" });
    expect(mockSubscribeNatsEvent).toHaveBeenCalledWith("cart.item_added", expect.any(Function), { queueGroup: "cart-intelligence" });
