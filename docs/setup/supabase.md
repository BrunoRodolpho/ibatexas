...
> **Staging + production only.** Local dev uses Docker Postgres via `ibx dev`. See [ARCHITECTURE.md](../ARCHITECTURE.md#5-environments--dev-vs-staging-vs-production) for the full environment matrix.
