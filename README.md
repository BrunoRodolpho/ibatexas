...
Monorepo: Next.js storefront, Fastify API, WhatsApp channel, Claude AI agent (17 tools), Medusa v2 commerce, owner admin panel. See [PROJECT_STATE.md](docs/PROJECT_STATE.md) for what works today.
...
See [docs/cli/reference.md](docs/cli/reference.md) for the full CLI reference (31 top-level commands).
...
| API | `apps/api` | Fastify REST API — public + admin routes, SSE chat stream, Swagger docs |
...
| Agent | Claude Sonnet (Anthropic), tool-use API — 17 tools |
...
| [docs/backlog/TODO-BACKLOG.md](docs/backlog/TODO-BACKLOG.md) | Pre-launch backlog (Steps 1-3 complete) + post-launch hardening & polish |
...
| Doc | Contents |
|-----|---------|
| [docs/cli/reference.md](docs/cli/reference.md) | Full `ibx` command reference (31 top-level commands) |
...
| [docs/architecture/design/agent-tools.md](docs/architecture/design/agent-tools.md) | 17 tools — auth level, inputs, outputs |
