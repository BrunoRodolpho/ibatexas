...
| Agent tools — auth level, inputs, outputs (18 LLM-callable) | [docs/architecture/design/agent-tools.md](docs/architecture/design/agent-tools.md) |
