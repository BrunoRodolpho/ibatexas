...
The four static passes are one of Language Engine 2.0's architectural
...
ticket that adds a pass (boot reconciliation, the journey / compensation /
lifecycle passes) turns this test red until its fixtures land in the same
change.
